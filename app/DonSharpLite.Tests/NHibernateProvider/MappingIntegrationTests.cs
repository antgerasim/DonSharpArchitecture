using System.IO;
using DonSharpLite.NHibernateProvider;
using NHibernate;
using NHibernate.Cfg;
using NHibernate.Tool.hbm2ddl;
using NUnit.Framework;

namespace DonSharpLite.Tests.NHibernateProvider
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public void CanGenerateDatabaseSchema() {
            using (ISession session = _sessionFactory.OpenSession()) {
                using (TextWriter stringWriter = new StreamWriter("../../../../app/DonSharpLite.DB/Schema/UnitTestGeneratedSchema.sql")) {
